...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  USB_DESC_TYPE_CONFIGURATION, /* bDescriptorType: (配置描述符)Configuration */
  ...
  USB_DESC_TYPE_INTERFACE,/*bDescriptorType: (HID设备接口描述符)Interface descriptor type*/
  ...
  CUSTOM_HID_DESCRIPTOR_TYPE, /*bDescriptorType: (HID报告描述符)CUSTOM_HID*/
