...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  USB_DESC_TYPE_CONFIGURATION, /* bDescriptorType: (ÅäÖÃÃèÊö·û)Configuration */
  ...
  USB_DESC_TYPE_INTERFACE,/*bDescriptorType: (HIDÉè±¸½Ó¿ÚÃèÊö·û)Interface descriptor type*/
  ...
  CUSTOM_HID_DESCRIPTOR_TYPE, /*bDescriptorType: (HID±¨¸æÃèÊö·û)CUSTOM_HID*/
...
#define USBD_VID                      0x0F0D //Hori Co., Ltd
